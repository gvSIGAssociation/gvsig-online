...
urlpatterns = [
    ...
    path('project_package_export_preflight/<int:pid>/', core_views.project_package_export_preflight, name='project_package_export_preflight'),
    path('project_package_export/<int:pid>/', core_views.project_package_export, name='project_package_export'),
    path('project_package_import/', core_views.project_package_import, name='project_package_import'),
    path('project_package_import_wizard/<uuid:job_id>/', core_views.project_package_import_wizard, name='project_package_import_wizard'),
    path('project_package_import_result/<uuid:job_id>/', core_views.project_package_import_result, name='project_package_import_result'),
    path('project_package_export_result/<int:log_id>/', core_views.project_package_export_result, name='project_package_export_result'),
    path('project_package_export_job/<uuid:job_id>/status/', core_views.export_job_status, name='export_job_status'),
    path('project_package_export_job/<uuid:job_id>/status.json', core_views.export_job_status_json, name='export_job_status_json'),
    path('project_package_export_job/<uuid:job_id>/download/', core_views.export_job_download, name='export_job_download'),
    path('project_package_import/<uuid:job_id>/status/', core_views.import_job_status, name='import_job_status'),
    path('project_package_import/<uuid:job_id>/status.json', core_views.import_job_status_json, name='import_job_status_json'),
    path('project_package_job/<str:job_type>/<uuid:job_id>/cancel/', core_views.cancel_package_job, name='cancel_package_job'),
    path('project_package_activity_log/', core_views.project_package_activity_log, name='project_package_activity_log'),
    path('project_package_activity_log/inprogress.json', core_views.activity_log_inprogress_json, name='activity_log_inprogress_json'),
