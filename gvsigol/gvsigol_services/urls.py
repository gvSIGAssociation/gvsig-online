...
urlpatterns = [
    ...
    url(r'^cache_clear/(?P<layer_id>[0-9]+)/$', services_views.cache_clear, name='cache_clear'),
    ...
    url(r'^base_layer/base_layer_list/$', services_views.base_layer_list, name='base_layer_list'),
