...
urlpatterns = [
    ...
    path('api/v1/layers/<int:lyr_id>/capabilities/', api_layer.LayerCapabilities.as_view(), name='get_layer_capabilities'),
    path('api/v1/layers/<int:lyr_id>/wmtsoptions/', api_layer.WmtsLayerOptions.as_view(), name='get_layer_wmts_options'),
    path('api/v1/layers/<int:lyr_id>/refresh/', api_layer.layer_refresh, name='refresh_layer'),
    path('api/v1/layers/<int:lyr_id>/cache/refresh/', api_layer.layer_cache_refresh, name='layer_cache_refresh'),
    path('api/v1/layers/<int:lyr_id>/cache/task/<str:task_id>/', api_feature.CacheTaskPollView.as_view(), name='cache_task_poll'),
