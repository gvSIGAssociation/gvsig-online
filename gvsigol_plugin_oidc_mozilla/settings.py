...
OIDC_OP_AUTHORIZATION_ENDPOINT = OIDC_OP_BASE_URL + "/realms/" + OIDC_OP_REALM_NAME + "/protocol/openid-connect/auth"
OIDC_OP_TOKEN_ENDPOINT = OIDC_OP_BASE_URL + "/realms/" + OIDC_OP_REALM_NAME + "/protocol/openid-connect/token"
OIDC_OP_USER_ENDPOINT = OIDC_OP_BASE_URL + "/realms/" + OIDC_OP_REALM_NAME + "/protocol/openid-connect/userinfo"
OIDC_OP_JWKS_ENDPOINT = OIDC_OP_BASE_URL + "/realms/" + OIDC_OP_REALM_NAME + "/protocol/openid-connect/certs"
OIDC_OP_LOGOUT_ENDPOINT = OIDC_OP_BASE_URL + "/realms/" + OIDC_OP_REALM_NAME + "/protocol/openid-connect/logout"
