...
env_plugin_oidc_mozilla = environ.Env(
    ...
    OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS=(int, 900)
 )
...
OIDC_EXEMPT_URLS = ['gvsigol_authenticate_user', 'gvsigol_logout_user', 'get-csrftoken']
...
OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS = env_plugin_oidc_mozilla('OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS')
...
LOGGER.info(f'OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS=${OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS}')
