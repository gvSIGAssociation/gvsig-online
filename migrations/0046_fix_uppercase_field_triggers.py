...
def install(trigger):
    ...
    i.install_trigger(trigger_name, target_schema, target_table,
                    trigger.procedure.activation, trigger.procedure.event, trigger.procedure.orientation, '', trigger.procedure.func_schema, trigger.procedure.__name__, [trigger.field])
    i.close()
...
def get_name(trigger):
    return trigger.procedure.__name__ + "_" + trigger.field + "_trigger"
