...
def create_datset_metadata(mdfields):
    ...
    metadata +=                   u'<gmd:code>'
    metadata +=                       u'<gco:CharacterString>' + crs + u'</gco:CharacterString>'
    metadata +=                   u'</gmd:code>'
    metadata +=               u'</gmd:RS_Identifier>'
    metadata +=           u'</gmd:referenceSystemIdentifier>'
    metadata +=       u'</gmd:MD_ReferenceSystem>'
    ...
    metadata +=                       u'<gco:CharacterString>' + title + u'</gco:CharacterString>'
    metadata +=                       u'<gmd:PT_FreeText>'
    metadata +=                           u'<gmd:textGroup>'
    metadata +=                               u'<gmd:LocalisedCharacterString locale="#ES">' + title + u'</gmd:LocalisedCharacterString>'
    metadata +=                           u'</gmd:textGroup>'
    metadata +=                       u'</gmd:PT_FreeText>'
    ...
    metadata +=                           u'<gmd:date>'
    metadata +=                               u'<gco:DateTime>' + text(datetime.now()) + u'</gco:DateTime>'
    metadata +=                           u'</gmd:date> '
    ...
    metadata +=               u'<gco:CharacterString>' + abstract + u'</gco:CharacterString>'
    metadata +=           u'</gmd:abstract>'
    metadata +=           u'<gmd:graphicOverview><gmd:MD_BrowseGraphic>'
    metadata +=               u'<gmd:fileName>'
    metadata +=                   u'<gco:CharacterString>' + thumbnail_url + u'</gco:CharacterString>'
    metadata +=               u'</gmd:fileName>'
    ...
    metadata +=                               u'<gco:Decimal>' + minx + u'</gco:Decimal>'
    metadata +=                           u'</gmd:westBoundLongitude>'
    metadata +=                           u'<gmd:eastBoundLongitude>'
    metadata +=                               u'<gco:Decimal>' + maxx + u'</gco:Decimal>'
    metadata +=                           u'</gmd:eastBoundLongitude>'
    metadata +=                           u'<gmd:southBoundLatitude>'
    metadata +=                               u'<gco:Decimal>' + miny + u'</gco:Decimal>'
    metadata +=                           u'</gmd:southBoundLatitude>'
    metadata +=                           u'<gmd:northBoundLatitude>'
    metadata +=                               u'<gco:Decimal>' + maxy + u'</gco:Decimal>'
    metadata +=                           u'</gmd:northBoundLatitude>'
    metadata +=                       u'</gmd:EX_GeographicBoundingBox>'
    metadata +=                   u'</gmd:geographicElement>'
    metadata +=               u'</gmd:EX_Extent>'
    ...
    metadata +=                               u'<gmd:URL>' + wms_endpoint + u'</gmd:URL>'
    metadata +=                           u'</gmd:linkage>'
    metadata +=                           u'<gmd:protocol>'
    metadata +=                               u'<gco:CharacterString>OGC:WMS</gco:CharacterString>'
    metadata +=                           u'</gmd:protocol>'
    metadata +=                           u'<gmd:name>'
    metadata +=                               u'<gco:CharacterString>' + qualified_name + u'</gco:CharacterString>'
    metadata +=                           u'</gmd:name>'
    ...
    if wfs_endpoint:
        ...
        metadata +=               u'<gmd:CI_OnlineResource>'
        metadata +=                   u'<gmd:linkage>'
        metadata +=                       u'<gmd:URL>' + wfs_endpoint + u'</gmd:URL>'
        metadata +=                   u'</gmd:linkage>'
        metadata +=                   u'<gmd:protocol>'
    ...
    if wcs_endpoint:
        ...
        metadata +=               u'<gmd:CI_OnlineResource>'
        metadata +=                   u'<gmd:linkage>'
        metadata +=                       u'<gmd:URL>' + wcs_endpoint + u'</gmd:URL>'
        metadata +=                   u'</gmd:linkage>'
        metadata +=                   u'<gmd:protocol>'
