...
urlpatterns = [
    path('sampledashboard/get_conf/', views.get_conf, name='sampledashboard_get_conf'),
    ...
    path('sampledashboard/sampledashboard_update/<int:lgid>/', views.sampledashboard_update, name='sampledashboard_update_by_id'),
]
