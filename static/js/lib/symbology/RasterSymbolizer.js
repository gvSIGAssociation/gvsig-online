...
var RasterSymbolizer = function(rule, options, utils) {
	this.id = 'rastersymbolizer' + utils.generateUUID();
	this.type = 'RasterSymbolizer';
	this.opacity = 1;
	this.order = 0;
...
RasterSymbolizer.prototype.getTableUI = function() {
	var ui = '';
...
RasterSymbolizer.prototype.getTabMenu = function() {
	var ui = '';
...
RasterSymbolizer.prototype.getEntryTabUI = function() {
	var ui = '';
...
RasterSymbolizer.prototype.registerEvents = function() {
	var self = this;
...
RasterSymbolizer.prototype.updatePreview = function() {	
...
RasterSymbolizer.prototype.toSLDBody = function(){
...
RasterSymbolizer.prototype.toXML = function(){
...
RasterSymbolizer.prototype.toJSON = function(){
