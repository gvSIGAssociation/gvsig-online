...
if [ -z "$OIDC_GVSIGOL_CONFIG_MODULE" ]; then
		echo "WARNING: OIDC_GVSIGOL_CONFIG_MODULE is not defined, using ''"
		OIDC_GVSIGOL_CONFIG_MODULE=""
fi
if [ -z "$OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS" ]; then
		echo "WARNING: OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS is not defined, using '900'"
...
echo "OIDC_GVSIGOL_CONFIG_MODULE" $OIDC_GVSIGOL_CONFIG_MODULE
echo "OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS" $OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS
...
grep -rl "##OIDC_GVSIGOL_CONFIG_MODULE##"  | xargs sed -i "s ##OIDC_GVSIGOL_CONFIG_MODULE## $OIDC_GVSIGOL_CONFIG_MODULE g"
grep -rl "##OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS##"  | xargs sed -i "s ##OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS## $OIDC_RENEW_ID_TOKEN_EXPIRY_SECONDS g"