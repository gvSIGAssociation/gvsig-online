...
urlpatterns = [
    ...
    path('layer_cache_clear/<int:layer_id>/', services_views.cache_clear, name='cache_clear'),
    path('layer_refresh_extent/<int:layer_id>/', services_views.layer_refresh_extent, name='layer_refresh_extent'),
    path('manage_cache_clear/<int:layer_id>/', services_views.manage_cache_clear, name='manage_cache_clear'),
    path('group_cache_clear/<int:layer_id>/', services_views.group_cache_clear, name='group_cache_clear'),
